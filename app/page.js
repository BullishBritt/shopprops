...
// ── PROP FIRM DATA ──────────────────────────────────────────
// Only these firms are surfaced on the site. Edit ACTIVE_FIRM_IDS to
// change which firms show (data for others is kept but hidden).
const ACTIVE_FIRM_IDS = ["tradeify", "lucid", "alphaF", "topstep", "bulenox"];
const ALL_FIRMS = [
  // ── TOP 5 FEATURED ──
...
// Surface only the active firms across the whole site.
const FIRMS = ALL_FIRMS.filter(f => ACTIVE_FIRM_IDS.includes(f.id));
    ...
    <div className="fadein">
      ...
      <section style={{...S.section,paddingTop:80,paddingBottom:80,textAlign:"center",maxWidth:900}}>
        ...
        <div style={{display:"flex",gap:32,justifyContent:"center",marginTop:48,flexWrap:"wrap"}}>
          {[["5","Top Firms"],["$0","Pay-to-Rank"],[PROMO,"Promo Code"],["Daily","Updated"]].map(([v,l]) => (
      ...
      <section style={{...S.section,paddingBottom:60}}>
        ...
        <div style={{...S.grid,gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))"}}>
          {[
            ...
            {rank:"#4",title:"Most Trusted",firm:FIRMS.find(f=>f.id==="topstep"),reason:"One of the oldest names in the game (since 2012). End-of-day trailing drawdown, 100% of your first $5K, and a long track record of paying traders."},
            {rank:"#5",title:"Budget Weekly Payouts",firm:FIRMS.find(f=>f.id==="bulenox"),reason:"Budget-friendly pricing with weekly payouts and multiple plan options. Keep 100% of your first $10K in profits."},
